...
mycursor.execute("CREATE TABLE phone(phone_id INT, country_code INT NOT NULL, phone_number INT NOT NULL, phone_type VARCHAR(12), PRIMARY KEY(phone_id));")

#Write the Python code to select rows from the table based on the following SQL statement:
mycursor.execute("SELECT phone_number, FROM phone,WHERE country_code = 'US' ")
